...
function VillainsPage({ data }: IHeroPage) {
  ...
  return (
    <Fragment>
      <Head>
        <title>Villain Attack</title>
        <meta name="description" content="Find all villains by their name" />
            ...
            <div className={styles.flex}>
              ...
              <p className={!showHint ? styles.blurry : ""}>
                {hero.work.occupation === "-"
                  ? "unknown"
                  : hero.work.occupation.length > 70
                  ? hero.work.occupation.slice(0, 67) + "..."
                  : hero.work.occupation}
              </p>
            </div>
            <div className={styles.flex}>
